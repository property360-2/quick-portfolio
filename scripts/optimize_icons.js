...
const iconMap = {
  ...
  article:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/></svg>',
  close:
  ...
  inbox:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',
  refresh:
  ...
  lock_outline:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 17c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm6-9h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM8.9 6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2H8.9V6zM18 20H6V10h12v10z"/></svg>',
  drafts:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 13L2 6.67V18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6.67L12 13zM12 11l8.52-5.51C20.18 5.14 19.62 5 19 5H5c-.62 0-1.18.14-1.52.49L12 11z"/></svg>',
  open_in_new:
  ...
  terminal:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zm-2-1h-6v-2h6v2zM7.5 17l-1.41-1.41L8.67 13l-2.59-2.59L7.5 9l4 4-4 4z"/></svg>',
  ...
  description:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zM13 9V3.5L18.5 9H13z"/></svg>',
  dashboard:
  ...
  account_tree:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M22 11V3h-7v3H9V3H2v8h7V8h2v10h4v3h7v-8h-7v3h-2V8h2v10h4v3h7v-8h-7v3h-2V8h2v3h7z"/></svg>',
  ads_click:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm0 18c4.41 0 8-3.59 8-8s-3.59-8-8-8-8 3.59-8 8 3.59 8 8 8zm-1-6h2v2h-2v-2zm0-7h2v5h-2V7z"/></svg>',
  trending_up:
  ...
  history:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.98 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>',
  ...
  receipt_long:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.5 3.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2v14H3v3c0 1.66 1.34 3 3 3h12c1.66 0 3-1.34 3-3V2l-1.5 1.5zM19 19c0 .55-.45 1-1 1s-1-.45-1-1v-3H8V5h11v14z"/></svg>',
  data_array:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15 4v2h3v12h-3v2h5V4zM4 20h5v-2H6V6h3V4H4z"/></svg>',
  assignment:
  ...
  payments:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 14V6c0-1.1-.9-2-2-2H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zm-2 0H3V6h14v8zm-7-7c-1.65 0-3 1.35-3 3s1.35 3 3 3 3-1.35 3-3-1.35-3-3-3zm13 2v10c0 1.1-.9 2-2 2H5v-2h14V9h2z"/></svg>',
  forward_to_inbox:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h9v-2H4V8l8 5 8-5v5h2V6c0-1.1-.9-2-2-2zm-8 7L4 6h16l-8 5zm7 4l4 4-4 4v-3h-4v-2h4v-3z"/></svg>',
  ...
  swap_horiz:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6.99 11L3 14.99 6.99 19v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z"/></svg>',
  ...
  sync_alt:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 12l-4 4v-3H3v-2h11V8l4 4zm-4.78-4.38L18.44 12l-5.22 4.38V13H3v-2h10.22V7.62zM6 12l4-4v3h11v2H10v3l-4-4zm4.78 4.38L6.56 12l5.22-4.38V11H21v2H11.78v3.38z"/></svg>',
  language:
  ...
  backup:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z"/></svg>',
  speed:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20.38 8.57L19.15 10.42c.16.63.23 1.28.23 1.96 0 4.41-3.59 8-8 8s-8-3.59-8-8 3.59-8 8-8c1.31 0 2.53.33 3.61.91L17.26 3.65C15.58 2.61 13.59 2 11.38 2 5.65 2 1 6.65 1 12.38s4.65 10.38 10.38 10.38 10.38-4.65 10.38-10.38c0-1.39-.27-2.71-.78-3.91zM10 17h2.76l-1.38-2.08L10 17zM17.24 7.32l-3.3 4.95c-.32-.23-.71-.37-1.14-.37-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2c0-.43-.14-.82-.37-1.14l4.95-3.3c.09-.06.14-.16.14-.27 0-.19-.16-.35-.35-.35-.11 0-.21.05-.27.14z"/></svg>',
  launch:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/></svg>',
  share:
...
walk(workingDir, (filePath) => {
  ...
  const iconRegex =
    /<span\s+[^>]*?class=([\\"'])([^>]*?material-icons-outlined[^>]*?)\1[^>]*?>([\s\S]*?)<\/span>/gi;
  ...
  if (ext === ".html") {
    content = content.replace(
      /<link[^>]*?href="[^"]*?fonts\.googleapis\.com\/icon\?family=Material\+Icons\+Outlined"[^>]*?>/gi,
